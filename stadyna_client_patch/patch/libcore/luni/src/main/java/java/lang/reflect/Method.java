...
public final class Method extends AccessibleObject implements GenericDeclaration, Member {
    ...
    public Object invoke(Object receiver, Object... args)
        ...
        try {
            jsonObj.put(Seccon.JSON_CLASS, Seccon.convertClassNameToDescriptor(declaringClass.getName()));
            jsonObj.put(Seccon.JSON_METHOD, getName());
            jsonObj.put(Seccon.JSON_PROTO, Seccon.convertSignatureToProto(getSignature()));
