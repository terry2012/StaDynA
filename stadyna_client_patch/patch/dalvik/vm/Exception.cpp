...
//            return;
        ...
        //begin SECCON
        const char* methProto = dexProtoGetMethodDescriptor(&meth->prototype, &stringCache);
        StringObject* proto = dvmCreateStringFromCstr(methProto);
        //ALOGW("!SECCON: Method Name: [%s], prototype: [%s]", meth->name, methProto);
...
//            ste, &unused, className, methodName, fileName, lineNumber);
        ...
        JValue unused;
        dvmCallMethod(dvmThreadSelf(), gDvm.methJavaLangStackTraceElementSeccon_init,
            ste, &unused, className, methodName, proto, fileName, lineNumber);
        //end SECCON
        ...
        //begin SECCON
        dvmReleaseTrackedAlloc((Object*) proto, NULL);
        //end SECCON
