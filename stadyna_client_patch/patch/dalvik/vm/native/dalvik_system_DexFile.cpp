...
//    JValue* pResult)
//{
static void Dalvik_dalvik_system_DexFile_openDexFileImpl(const u4* args,
	    JValue* pResult)
{
//end SECCON
...
const DalvikNativeMethod dvm_dalvik_system_DexFile[] = {
	...
	{ "openDexFileImpl",        "(Ljava/lang/String;Ljava/lang/String;I)I",
		Dalvik_dalvik_system_DexFile_openDexFileImpl },
	//end SECCON
    { "openDexFile",        "([B)I",
